...
def draw_permanent_markers():
    """Draw permanent yellow markers at the dome entry points."""
    glPointSize(10)
    glColor3f(1, 1, 0)  # Yellow markers
    glBegin(GL_POINTS)
...
def main():
    ...
    pygame.display.set_caption("🚀 Transparent Domes with High-Speed Trajectories & Permanent Markers")
